    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        public bool VoxelHighlight(VoxelHitInfo hitInfo, Color color, float edgeWidth = 0f) {
            ...
            if (voxelHighlightGO == null) {
                ...
                if (!voxelHighlightGO.TryGetComponent(out voxelHighlight)) { 
                    voxelHighlight = voxelHighlightGO.AddComponent<VoxelHighlight>();
                }
            } else {
                if (!voxelHighlightGO.TryGetComponent(out Renderer renderer)) return false;
                voxelHighlightMaterial = renderer.sharedMaterial;
            }
